...
int main(int argc, char** argv)
{
	...
	if (!myChip8.loadApplication("ROM\\tetris.c8"))
		return 1;
...
void updateTexture(const Chip8Bit& c8)
{
...
void updateQuads(const Chip8Bit& c8)
{
